...
def create_train_pconv_unet():
    ...
    img, mask = conv_bn_relu(img, mask,
                             filters=3, kernel_size=1, reps=1, act="output") # 出力
    ...
    vgg_in_comp = y_comp
    # vggの特徴量
    vgg_pred_1, vgg_pred_2, vgg_pred_3 = extract_vgg_features(vgg_in_pred, (448,336,3), 0)
    vgg_true_1, vgg_true_2, vgg_true_3 = extract_vgg_features(vgg_in_groundtruth, (448,336,3), 1)
    vgg_comp_1, vgg_comp_2, vgg_comp_3 = extract_vgg_features(vgg_in_comp, (448,336,3), 2)
    # 画像＋損失
